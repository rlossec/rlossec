...
## [Plateforme temps réel (en cours)](#)
**Application de jeu interactif en direct avec gestion des websockets**  
- **Stack** : React.js + TailwindCSS (front), Django Channels + Daphne (back temps réel), PostgreSQL.  
- **Fonctionnalités** :
...
- **Défis techniques** : logique serveur robuste (gestion des états, latence).  
